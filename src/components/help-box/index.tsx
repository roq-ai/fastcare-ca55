...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Healthcare Provider'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Medical Staff', 'Healthcare Provider', 'Insurance Agent', 'Pharmacy Staff'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `Fastcare`;
